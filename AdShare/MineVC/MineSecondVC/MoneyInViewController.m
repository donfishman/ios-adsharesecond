...
#import "MoneyInViewController.h"

@interface MoneyInViewController ()<UITableViewDataSource,UITableViewDelegate,UINavigationControllerDelegate>
...
@implementation MoneyInViewController
...
- (void)loadMoneyInDataAAA {
    NSDictionary * dict = [NSDictionary dictionaryWithObjectsAndKeys:UserDefaults(@"uid"),@"uid",@"1",@"type", nil];
